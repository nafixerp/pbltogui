...
WINDOW = Window(
    ...
    grid={'control': 'dw_1', 'dataobject': 'd_loanbalance_rep', 'table': 'loan', 'keys': ['slno'], 'computes': [{'name': 'loanbal', 'expression': ' loanamt  -  if(isnull( tcolln ),0,tcolln)', 'format': '#######0.00', 'label': 'loanbal', 'band': 'detail'}, {'name': 'advbal', 'expression': 'advance -  if(isnull( tadvadj ),0,tadvadj)', 'format': '#######0.00', 'label': 'advbal', 'band': 'detail'}, {'name': 'grandbal', 'expression': 'loanbal - advbal + if(isnull(  tintadj ),0,tintadj)', 'format': '########0.00', 'label': 'grandbal', 'band': 'detail'}, {'name': 'compute_4', 'expression': 'sum(loanamt for all)', 'format': '########0.00', 'label': 'compute_4', 'band': 'summary'}, {'name': 'compute_5', 'expression': 'sum(tcolln for all)', 'format': '#######0.00', 'label': 'compute_5', 'band': 'summary'}, {'name': 'compute_6', 'expression': 'sum( loanbal for all)', 'format': '#######0.00', 'label': 'compute_6', 'band': 'summary'}, {'name': 'compute_7', 'expression': 'sum(advance for all)', 'format': '#######0.00', 'label': 'compute_7', 'band': 'summary'}, {'name': 'compute_8', 'expression': 'sum(tadvadj for all)', 'format': '######0.00', 'label': 'compute_8', 'band': 'summary'}, {'name': 'compute_9', 'expression': 'sum(advbal for all)', 'format': '######0.00', 'label': 'compute_9', 'band': 'summary'}, {'name': 'compute_10', 'expression': 'sum(tintadj for all)', 'format': '######0.00', 'label': 'compute_10', 'band': 'summary'}, {'name': 'compute_11', 'expression': 'sum( grandbal for all)', 'format': '########0.00', 'label': 'compute_11', 'band': 'summary'}], 'columns': [{'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'docno', 'label': 'docno', 'type': 'char'}, {'name': 'billno', 'label': 'billno', 'type': 'char'}, {'name': 'ccode', 'label': 'ccode', 'type': 'char'}, {'name': 'grate', 'label': 'grate', 'type': 'decimal'}, {'name': 'loanamt', 'label': 'loanamt', 'type': 'decimal'}, {'name': 'advance', 'label': 'advance', 'type': 'decimal'}, {'name': 'instnos', 'label': 'instnos', 'type': 'long'}, {'name': 'instamt', 'label': 'instamt', 'type': 'decimal'}, {'name': 'collntype', 'label': 'collntype', 'type': 'char'}, {'name': 'collnstart', 'label': 'collnstart', 'type': 'date'}, {'name': 'closed', 'label': 'closed', 'type': 'char'}, {'name': 'slno', 'label': 'slno', 'type': 'decimal'}, {'name': 'cname', 'label': 'cname', 'type': 'char'}, {'name': 'tcolln', 'label': 'tcolln', 'type': 'decimal'}, {'name': 'tadvadj', 'label': 'tadvadj', 'type': 'decimal'}, {'name': 'tintadj2', 'label': 'tintadj2', 'type': 'decimal'}, {'name': 'tintadj', 'label': 'tintadj', 'type': 'decimal'}]},
    report={'dataobject': 'd_loanbalance_rep', 'sql': 'SELECT loan.tdate AS loan_tdate, loan.docno AS loan_docno, loan.billno AS loan_billno, loan.ccode AS loan_ccode, loan.grate AS loan_grate, loan.loanamt AS loan_loanamt, loan.advance AS loan_advance, loan.instnos AS loan_instnos, loan.instamt AS loan_instamt, loan.collntype AS loan_collntype, loan.collnstart AS loan_collnstart, loan.closed AS loan_closed, loan.slno AS loan_slno, (select clients.name from clients where clients.code = loan.ccode) as cname, (select sum(loancolln.ramt) from loancolln where loancolln.loanno = loan.docno) as tcolln, (select sum(loancolln.advadj) from loancolln where loancolln.loanno = loan.docno) as tadvadj, (select sum(loancolln.intamt) from loancolln where loancolln.loanno = loan.docno) as tintadj2, (interestamt + ifnull(tintadj2,0,tintadj2)) as tintadj FROM loan ORDER BY loan.tdate ASC, loan.docno ASC', 'computes': [{'name': 'loanbal', 'expression': ' loanamt  -  if(isnull( tcolln ),0,tcolln)', 'format': '#######0.00', 'label': 'loanbal', 'band': 'detail'}, {'name': 'advbal', 'expression': 'advance -  if(isnull( tadvadj ),0,tadvadj)', 'format': '#######0.00', 'label': 'advbal', 'band': 'detail'}, {'name': 'grandbal', 'expression': 'loanbal - advbal + if(isnull(  tintadj ),0,tintadj)', 'format': '########0.00', 'label': 'grandbal', 'band': 'detail'}, {'name': 'compute_4', 'expression': 'sum(loanamt for all)', 'format': '########0.00', 'label': 'compute_4', 'band': 'summary'}, {'name': 'compute_5', 'expression': 'sum(tcolln for all)', 'format': '#######0.00', 'label': 'compute_5', 'band': 'summary'}, {'name': 'compute_6', 'expression': 'sum( loanbal for all)', 'format': '#######0.00', 'label': 'compute_6', 'band': 'summary'}, {'name': 'compute_7', 'expression': 'sum(advance for all)', 'format': '#######0.00', 'label': 'compute_7', 'band': 'summary'}, {'name': 'compute_8', 'expression': 'sum(tadvadj for all)', 'format': '######0.00', 'label': 'compute_8', 'band': 'summary'}, {'name': 'compute_9', 'expression': 'sum(advbal for all)', 'format': '######0.00', 'label': 'compute_9', 'band': 'summary'}, {'name': 'compute_10', 'expression': 'sum(tintadj for all)', 'format': '######0.00', 'label': 'compute_10', 'band': 'summary'}, {'name': 'compute_11', 'expression': 'sum( grandbal for all)', 'format': '########0.00', 'label': 'compute_11', 'band': 'summary'}], 'args': ['rdate1', 'rdate2', 'rlevel'], 'arg_types': {'rdate1': 'date', 'rdate2': 'date', 'rlevel': 'number'}, 'tables': ['loan'], 'columns': [{'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'docno', 'label': 'docno', 'type': 'char'}, {'name': 'billno', 'label': 'billno', 'type': 'char'}, {'name': 'ccode', 'label': 'ccode', 'type': 'char'}, {'name': 'grate', 'label': 'grate', 'type': 'decimal'}, {'name': 'loanamt', 'label': 'loanamt', 'type': 'decimal'}, {'name': 'advance', 'label': 'advance', 'type': 'decimal'}, {'name': 'instnos', 'label': 'instnos', 'type': 'long'}, {'name': 'instamt', 'label': 'instamt', 'type': 'decimal'}, {'name': 'collntype', 'label': 'collntype', 'type': 'char'}, {'name': 'collnstart', 'label': 'collnstart', 'type': 'date'}, {'name': 'closed', 'label': 'closed', 'type': 'char'}, {'name': 'slno', 'label': 'slno', 'type': 'decimal'}, {'name': 'cname', 'label': 'cname', 'type': 'char'}, {'name': 'tcolln', 'label': 'tcolln', 'type': 'decimal'}, {'name': 'tadvadj', 'label': 'tadvadj', 'type': 'decimal'}, {'name': 'tintadj2', 'label': 'tintadj2', 'type': 'decimal'}, {'name': 'tintadj', 'label': 'tintadj', 'type': 'decimal'}]},
)
