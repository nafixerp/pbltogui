"""Extra Amt Report — w_jewl_extraamt_report.

Generated from the PowerBuilder window ``w_jewl_extraamt_report.srw`` by
...
class ExtraAmtReportForm(GeneratedForm):
    ...
    def build_controls(self):
        ...
        self.add('datawindow', 'dw_1', 0, 104, 3616, 2084, dataobject='d_jewl_extraamt_report', taborder=60)
