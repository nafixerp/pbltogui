...
WINDOW = Window(
    ...
    grid={'control': 'dw_mnthreport', 'dataobject': 'd_mnthsalereport', 'table': 'salesm', 'keys': ['slno'], 'computes': [{'name': 'tramt', 'expression': 'ramt', 'format': '#######0.00', 'label': 'tramt', 'band': 'detail'}, {'name': 'balance', 'expression': ' billamt  +  staxamt   -  eamt  -  sretamt -  advance  - discount + round  -  ramt  -  ramtafter ', 'format': '######0.00', 'label': 'balance', 'band': 'detail'}, {'name': 'compute_2', 'expression': ' sum(  billamt for all ) ', 'format': '#######0.00', 'label': 'compute_2', 'band': 'summary'}, {'name': 'compute_4', 'expression': 'sum(eamt for all)', 'format': '#######0.00', 'label': 'compute_4', 'band': 'summary'}, {'name': 'compute_5', 'expression': 'sum(sretamt for all)', 'format': '#######0.00', 'label': 'compute_5', 'band': 'summary'}, {'name': 'compute_7', 'expression': 'sum(discount for all)', 'format': '####0.00', 'label': 'compute_7', 'band': 'summary'}, {'name': 'compute_3', 'expression': 'sum(  tramt for all )', 'format': '######0.00', 'label': 'compute_3', 'band': 'summary'}, {'name': 'compute_6', 'expression': 'sum(balance  for all)', 'format': '######0.00', 'label': 'compute_6', 'band': 'summary'}], 'columns': [{'name': 'slno', 'label': 'slno', 'type': 'decimal'}, {'name': 'billno', 'label': 'Bill No.', 'type': 'char'}, {'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'custcode', 'label': 'custcode', 'type': 'char'}, {'name': 'custname', 'label': 'Customer Code and Name', 'type': 'char'}, {'name': 'billamt', 'label': 'Bill Amt', 'type': 'decimal'}, {'name': 'eamt', 'label': 'eamt', 'type': 'decimal'}, {'name': 'staxamt', 'label': 'staxamt', 'type': 'decimal'}, {'name': 'discount', 'label': 'Discount', 'type': 'decimal'}, {'name': 'ramt', 'label': 'Received', 'type': 'decimal'}, {'name': 'sretamt', 'label': 'sretamt', 'type': 'decimal'}, {'name': 'ramtafter', 'label': 'ramtafter', 'type': 'decimal'}, {'name': 'round', 'label': 'round', 'type': 'decimal'}, {'name': 'advance', 'label': 'advance', 'type': 'decimal'}, {'name': 'smcode', 'label': 'smcode', 'type': 'char'}]},
    report={'dataobject': 'd_mnthsalereport', 'sql': "SELECT salesm.slno AS salesm_slno, salesm.billno AS salesm_billno, salesm.tdate AS salesm_tdate, salesm.custcode AS salesm_custcode, salesm.custname AS salesm_custname, salesm.billamt AS salesm_billamt, salesm.eamt AS salesm_eamt, salesm.staxamt AS salesm_staxamt, salesm.discount AS salesm_discount, salesm.ramt AS salesm_ramt, salesm.sretamt AS salesm_sretamt, salesm.ramtafter AS salesm_ramtafter, salesm.round AS salesm_round, salesm.advance AS salesm_advance, salesm.smcode AS salesm_smcode FROM salesm WHERE salesm.control <= :rlevel AND salesm.sr = 'S' ORDER BY salesm.tdate ASC, salesm.slno ASC", 'computes': [{'name': 'tramt', 'expression': 'ramt', 'format': '#######0.00', 'label': 'tramt', 'band': 'detail'}, {'name': 'balance', 'expression': ' billamt  +  staxamt   -  eamt  -  sretamt -  advance  - discount + round  -  ramt  -  ramtafter ', 'format': '######0.00', 'label': 'balance', 'band': 'detail'}, {'name': 'compute_2', 'expression': ' sum(  billamt for all ) ', 'format': '#######0.00', 'label': 'compute_2', 'band': 'summary'}, {'name': 'compute_4', 'expression': 'sum(eamt for all)', 'format': '#######0.00', 'label': 'compute_4', 'band': 'summary'}, {'name': 'compute_5', 'expression': 'sum(sretamt for all)', 'format': '#######0.00', 'label': 'compute_5', 'band': 'summary'}, {'name': 'compute_7', 'expression': 'sum(discount for all)', 'format': '####0.00', 'label': 'compute_7', 'band': 'summary'}, {'name': 'compute_3', 'expression': 'sum(  tramt for all )', 'format': '######0.00', 'label': 'compute_3', 'band': 'summary'}, {'name': 'compute_6', 'expression': 'sum(balance  for all)', 'format': '######0.00', 'label': 'compute_6', 'band': 'summary'}], 'args': ['rdate1', 'rdate2', 'rlevel', 'rsmcode'], 'arg_types': {'rdate1': 'date', 'rdate2': 'date', 'rlevel': 'number', 'rsmcode': 'string'}, 'tables': ['salesm'], 'columns': [{'name': 'slno', 'label': 'slno', 'type': 'decimal'}, {'name': 'billno', 'label': 'Bill No.', 'type': 'char'}, {'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'custcode', 'label': 'custcode', 'type': 'char'}, {'name': 'custname', 'label': 'Customer Code and Name', 'type': 'char'}, {'name': 'billamt', 'label': 'Bill Amt', 'type': 'decimal'}, {'name': 'eamt', 'label': 'eamt', 'type': 'decimal'}, {'name': 'staxamt', 'label': 'staxamt', 'type': 'decimal'}, {'name': 'discount', 'label': 'Discount', 'type': 'decimal'}, {'name': 'ramt', 'label': 'Received', 'type': 'decimal'}, {'name': 'sretamt', 'label': 'sretamt', 'type': 'decimal'}, {'name': 'ramtafter', 'label': 'ramtafter', 'type': 'decimal'}, {'name': 'round', 'label': 'round', 'type': 'decimal'}, {'name': 'advance', 'label': 'advance', 'type': 'decimal'}, {'name': 'smcode', 'label': 'smcode', 'type': 'char'}]},
    opens=['w_mnthgraph'],
)
