...
WINDOW = Window(
    ...
    grid={'control': 'dw_trans', 'dataobject': 'd_staffleave', 'table': 'clients', 'keys': ['code'], 'columns': [{'name': 'code', 'label': 'code', 'type': 'char'}, {'name': 'name', 'label': 'Name', 'type': 'char'}, {'name': 'salary', 'label': 'salary', 'type': 'decimal'}, {'name': 'ldays', 'label': 'ldays', 'type': 'decimal'}, {'name': 'reason', 'label': 'reason', 'type': 'char'}, {'name': 'note', 'label': 'note', 'type': 'char'}, {'name': 'plusdays', 'label': 'plusdays', 'type': 'decimal'}]},
    report={'dataobject': 'd_staffleave', 'sql': 'SELECT clients.code AS clients_code, clients.name AS clients_name, clients.salary AS clients_salary, (select staffleave.ldays from staffleave where staffleave.staff = clients.code and staffleave.tdate = :rdate) as  ldays, (select staffleave.reason from staffleave where staffleave.staff = clients.code and staffleave.tdate = :rdate) as  reason, (select staffleave.note from staffleave where staffleave.staff = clients.code and staffleave.tdate = :rdate) as  note, (select staffleave.plusdays from staffleave where staffleave.staff = clients.code and staffleave.tdate = :rdate) as  plusdays FROM clients ORDER BY clients.name ASC', 'args': ['rdate'], 'arg_types': {'rdate': 'date'}, 'tables': ['clients'], 'columns': [{'name': 'code', 'label': 'code', 'type': 'char'}, {'name': 'name', 'label': 'Name', 'type': 'char'}, {'name': 'salary', 'label': 'salary', 'type': 'decimal'}, {'name': 'ldays', 'label': 'ldays', 'type': 'decimal'}, {'name': 'reason', 'label': 'reason', 'type': 'char'}, {'name': 'note', 'label': 'note', 'type': 'char'}, {'name': 'plusdays', 'label': 'plusdays', 'type': 'decimal'}]},
)
