...
WINDOW = Window(
    ...
    grid={'control': 'dw_updaterep', 'dataobject': 'd_accounts_position', 'table': 'accountm', 'keys': ['accode'], 'computes': [], 'columns': [{'name': 'accode', 'label': 'A/c Code', 'type': 'char'}, {'name': 'name', 'label': 'A/c Name', 'type': 'char'}, {'name': 'grcode', 'label': 'grcode', 'type': 'char'}, {'name': 'tplpos', 'label': 'tplpos', 'type': 'long'}, {'name': 'bshead', 'label': 'bshead', 'type': 'char'}, {'name': 'shepos', 'label': 'shepos', 'type': 'long'}, {'name': 'shedgrp', 'label': 'shedgrp', 'type': 'char'}]},
    report={'dataobject': 'd_accounts_position', 'sql': 'SELECT accountm.accode AS accountm_accode, accountm.name AS accountm_name, accountm.grcode AS accountm_grcode, accountm.tplpos AS accountm_tplpos, accountm.bshead AS accountm_bshead, accountm.shepos AS accountm_shepos, accountm.shedgrp AS accountm_shedgrp FROM accountm ORDER BY accountm.name ASC', 'computes': [], 'args': [], 'arg_types': {}, 'tables': ['accountm'], 'columns': [{'name': 'accode', 'label': 'A/c Code', 'type': 'char'}, {'name': 'name', 'label': 'A/c Name', 'type': 'char'}, {'name': 'grcode', 'label': 'grcode', 'type': 'char'}, {'name': 'tplpos', 'label': 'tplpos', 'type': 'long'}, {'name': 'bshead', 'label': 'bshead', 'type': 'char'}, {'name': 'shepos', 'label': 'shepos', 'type': 'long'}, {'name': 'shedgrp', 'label': 'shedgrp', 'type': 'char'}]},
)
