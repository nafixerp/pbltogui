...
WINDOW = Window(
    ...
    grid={'control': 'dw_ruffwork', 'dataobject': 'd_gsmithnewwrk', 'table': 'smithnewwrk', 'keys': ['sno'], 'computes': [], 'columns': [{'name': 'smithcode', 'label': 'Smith', 'type': 'char'}, {'name': 'tdate', 'label': 'Date', 'type': 'date'}, {'name': 'ordno', 'label': 'Order No', 'type': 'char'}, {'name': 'icode', 'label': 'icode', 'type': 'char'}, {'name': 'qty', 'label': 'qty', 'type': 'long'}, {'name': 'weight', 'label': 'weight', 'type': 'decimal'}, {'name': 'part', 'label': 'Particulars', 'type': 'char'}, {'name': 'status', 'label': 'Status', 'type': 'long'}, {'name': 'sno', 'label': 'sno', 'type': 'long'}]},
    report={'dataobject': 'd_gsmithnewwrk', 'sql': 'SELECT smithnewwrk.smithcode AS smithnewwrk_smithcode, smithnewwrk.tdate AS smithnewwrk_tdate, smithnewwrk.ordno AS smithnewwrk_ordno, smithnewwrk.icode AS smithnewwrk_icode, smithnewwrk.qty AS smithnewwrk_qty, smithnewwrk.weight AS smithnewwrk_weight, smithnewwrk.part AS smithnewwrk_part, smithnewwrk.status AS smithnewwrk_status, smithnewwrk.sno AS smithnewwrk_sno FROM smithnewwrk', 'computes': [], 'args': [], 'arg_types': {}, 'tables': ['smithnewwrk'], 'columns': [{'name': 'smithcode', 'label': 'Smith', 'type': 'char'}, {'name': 'tdate', 'label': 'Date', 'type': 'date'}, {'name': 'ordno', 'label': 'Order No', 'type': 'char'}, {'name': 'icode', 'label': 'icode', 'type': 'char'}, {'name': 'qty', 'label': 'qty', 'type': 'long'}, {'name': 'weight', 'label': 'weight', 'type': 'decimal'}, {'name': 'part', 'label': 'Particulars', 'type': 'char'}, {'name': 'status', 'label': 'Status', 'type': 'long'}, {'name': 'sno', 'label': 'sno', 'type': 'long'}]},
    opens=['w_orderhelp', 'w_itemhelp', 'w_clientshelp'],
)
