...
WINDOW = Window(
    ...
    grid={'control': 'dw_wstgset', 'dataobject': 'd_rotable', 'table': 'rotable', 'keys': ['code', 'model', 'size', 'weight1', 'weight2'], 'computes': [], 'columns': [{'name': 'code', 'label': 'code', 'type': 'char'}, {'name': 'model', 'label': 'Model', 'type': 'char'}, {'name': 'size', 'label': 'Size', 'type': 'char'}, {'name': 'weight1', 'label': 'Min Wgt', 'type': 'decimal'}, {'name': 'weight2', 'label': 'Max Wgt', 'type': 'decimal'}, {'name': 'minqty', 'label': 'Min Qty', 'type': 'long'}, {'name': 'maxqty', 'label': 'Max Qty', 'type': 'long'}]},
    report={'dataobject': 'd_rotable', 'sql': 'SELECT rotable.code AS rotable_code, rotable.model AS rotable_model, rotable.size AS rotable_size, rotable.weight1 AS rotable_weight1, rotable.weight2 AS rotable_weight2, rotable.minqty AS rotable_minqty, rotable.maxqty AS rotable_maxqty FROM rotable ORDER BY rotable.model ASC, rotable.size ASC, rotable.weight1 ASC, rotable.weight2 ASC', 'computes': [], 'args': ['rcode'], 'arg_types': {'rcode': 'string'}, 'tables': ['rotable'], 'columns': [{'name': 'code', 'label': 'code', 'type': 'char'}, {'name': 'model', 'label': 'Model', 'type': 'char'}, {'name': 'size', 'label': 'Size', 'type': 'char'}, {'name': 'weight1', 'label': 'Min Wgt', 'type': 'decimal'}, {'name': 'weight2', 'label': 'Max Wgt', 'type': 'decimal'}, {'name': 'minqty', 'label': 'Min Qty', 'type': 'long'}, {'name': 'maxqty', 'label': 'Max Qty', 'type': 'long'}]},
    opens=['w_itemhelp'],
)
