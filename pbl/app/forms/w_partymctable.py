...
WINDOW = Window(
    ...
    grid={'control': 'dw_party', 'dataobject': 'd_smith', 'table': 'codehelp', 'keys': ['code'], 'computes': [], 'columns': [{'name': 'code', 'label': 'code', 'type': 'char'}]},
    report={'dataobject': 'd_partymcmast', 'sql': 'SELECT pmctable.icode AS pmctable_icode, pmctable.model AS pmctable_model, pmctable.wastage AS pmctable_wastage, pmctable.mc AS pmctable_mc, pmctable.mcperc AS pmctable_mcperc, pmctable.mcperqty AS pmctable_mcperqty, pmctable.touch AS pmctable_touch, pmctable.formula AS pmctable_formula FROM pmctable', 'computes': [], 'args': ['rpcode'], 'arg_types': {'rpcode': 'string'}, 'tables': ['pmctable'], 'columns': [{'name': 'icode', 'label': 'Item', 'type': 'char'}, {'name': 'model', 'label': 'Model', 'type': 'char'}, {'name': 'wastage', 'label': 'Wstg%', 'type': 'decimal'}, {'name': 'mc', 'label': 'MC /gm', 'type': 'decimal'}, {'name': 'mcperc', 'label': 'MC%', 'type': 'decimal'}, {'name': 'mcperqty', 'label': 'MC /Qty', 'type': 'decimal'}, {'name': 'touch', 'label': 'touch', 'type': 'decimal'}, {'name': 'formula', 'label': 'formula', 'type': 'char'}]},
    opens=['w_clientshelp', 'w_smith', 'w_item', 'w_models'],
)
