"""Received Details — w_rcptdetail.

Generated from the PowerBuilder window ``w_rcptdetail.srw`` by
...
class ReceivedDetailsForm(GeneratedForm):
    ...
    def build_controls(self):
        ...
        self.add('datawindow', 'dw_acsummary', 5, 108, 3547, 2048, dataobject='d_rcptdetail', taborder=40)
