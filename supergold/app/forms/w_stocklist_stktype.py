...
WINDOW = Window(
    ...
    grid={'control': 'dw_1', 'dataobject': 'd_stocklistreport_stktype', 'table': 'items', 'keys': ['code'], 'computes': [{'name': 'cqty', 'expression': 'if(rlevel=1,qty,qtyB)', 'format': '#####0', 'label': 'cqty', 'band': 'detail'}, {'name': 'cwgt', 'expression': 'if(rlevel=1,weight,weightb)', 'format': '######0.000', 'label': 'cwgt', 'band': 'detail'}, {'name': 'cstwgt', 'expression': 'if(rlevel=1,stonewgt,stonewgtb)', 'format': '####0.000', 'label': 'cstwgt', 'band': 'detail'}, {'name': 'netwgt', 'expression': ' cwgt  -  cstwgt ', 'format': '######0.000', 'label': 'netwgt', 'band': 'detail'}, {'name': '', 'expression': 'count(code for all)', 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(if(rlevel=1,stonewgt,stonewgtb) for all)', 'format': '####0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G', netwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='S',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='S',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='O',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='O',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}], 'columns': [{'name': 'name', 'label': 'Item Name', 'type': 'char'}, {'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'regionalname', 'label': 'regionalname', 'type': 'char'}, {'name': 'itype', 'label': 'itype', 'type': 'char'}, {'name': 'ornament', 'label': 'ornament', 'type': 'char'}, {'name': 'cost', 'label': 'cost', 'type': 'decimal'}, {'name': 'grpcode', 'label': 'grpcode', 'type': 'char'}, {'name': 'qty', 'label': 'qty', 'type': 'long'}, {'name': 'weight', 'label': 'weight', 'type': 'decimal'}, {'name': 'stonewgt', 'label': 'St.Wgt.', 'type': 'decimal'}, {'name': 'qtyb', 'label': 'qtyb', 'type': 'long'}, {'name': 'weightb', 'label': 'weightb', 'type': 'decimal'}, {'name': 'stonewgtb', 'label': 'stonewgtb', 'type': 'decimal'}]},
    report={'dataobject': 'd_stocklistreport_stktype', 'sql': 'SELECT items.name AS items_name, items.code AS items_code, items.regionalname AS items_regionalname, items.itype AS items_itype, items.ornament AS items_ornament, items.cost AS items_cost, items.grpcode AS items_grpcode, (select sum(itemsstk.qty) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as qty, (select sum(itemsstk.weight) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as weight, (select sum(itemsstk.stonewgt) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as stonewgt, (select sum(itemsstk.qtyb) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as qtyb, (select sum(itemsstk.weightb) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as weightb, (select sum(itemsstk.stonewgtb) from itemsstk where itemsstk.code = items.code and itemsstk.stktype = ifnull(:rtype,itemsstk.stktype,:rtype)) as stonewgtb FROM items ORDER BY items.name ASC', 'computes': [{'name': 'cqty', 'expression': 'if(rlevel=1,qty,qtyB)', 'format': '#####0', 'label': 'cqty', 'band': 'detail'}, {'name': 'cwgt', 'expression': 'if(rlevel=1,weight,weightb)', 'format': '######0.000', 'label': 'cwgt', 'band': 'detail'}, {'name': 'cstwgt', 'expression': 'if(rlevel=1,stonewgt,stonewgtb)', 'format': '####0.000', 'label': 'cstwgt', 'band': 'detail'}, {'name': 'netwgt', 'expression': ' cwgt  -  cstwgt ', 'format': '######0.000', 'label': 'netwgt', 'band': 'detail'}, {'name': '', 'expression': 'count(code for all)', 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(if(rlevel=1,stonewgt,stonewgtb) for all)', 'format': '####0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='G', netwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='S',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='S',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='O',cqty,0) for all)", 'format': '#####0', 'label': '', 'band': 'summary'}, {'name': '', 'expression': "sum( if(itype='O',cwgt,0) for all)", 'format': '######0.000', 'label': '', 'band': 'summary'}], 'args': ['rlevel', 'rtype'], 'arg_types': {'rlevel': 'number', 'rtype': 'string'}, 'tables': ['items'], 'columns': [{'name': 'name', 'label': 'Item Name', 'type': 'char'}, {'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'regionalname', 'label': 'regionalname', 'type': 'char'}, {'name': 'itype', 'label': 'itype', 'type': 'char'}, {'name': 'ornament', 'label': 'ornament', 'type': 'char'}, {'name': 'cost', 'label': 'cost', 'type': 'decimal'}, {'name': 'grpcode', 'label': 'grpcode', 'type': 'char'}, {'name': 'qty', 'label': 'qty', 'type': 'long'}, {'name': 'weight', 'label': 'weight', 'type': 'decimal'}, {'name': 'stonewgt', 'label': 'St.Wgt.', 'type': 'decimal'}, {'name': 'qtyb', 'label': 'qtyb', 'type': 'long'}, {'name': 'weightb', 'label': 'weightb', 'type': 'decimal'}, {'name': 'stonewgtb', 'label': 'stonewgtb', 'type': 'decimal'}]},
