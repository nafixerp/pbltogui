...
Generated from the PowerBuilder window ``w_seditbillno.srw`` by
...
WINDOW = Window(
    ...
    controls=[],
    tables=['salesm'],
    source_path='w_seditbillno.srw',
    opens=['w_salehelp', 'w_ordersale', 'w_sales'],
)
...
class EditForm(GeneratedForm):
    ...
    def build_controls(self):
        ...
        self.add('statictext', 'st_1', 142, 64, 425, 64, text='Enter Bill no :')
        self.add('editmask', 'em_date', 567, 184, 421, 92, taborder=21)
        self.add('statictext', 'st_2', 288, 204, 247, 76, text='Date :')
