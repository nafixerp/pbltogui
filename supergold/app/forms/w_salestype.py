...
WINDOW = Window(
    ...
    grid={'control': 'dw_1', 'dataobject': 'd_salestype', 'table': 'salestype', 'keys': ['code'], 'columns': [{'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'name', 'label': 'Name', 'type': 'char'}, {'name': 'taxperc', 'label': 'Tax%', 'type': 'decimal'}, {'name': 'formno', 'label': 'Form No', 'type': 'char'}, {'name': 'prefix', 'label': 'SPrefix', 'type': 'char'}, {'name': 'startno', 'label': 'SStartNo', 'type': 'long'}, {'name': 'srprefix', 'label': 'SR Prefix', 'type': 'char'}, {'name': 'srstartno', 'label': 'SR Start No', 'type': 'long'}, {'name': 'pprefix', 'label': 'PPrefix', 'type': 'char'}, {'name': 'pstartno', 'label': 'PStartNo', 'type': 'long'}, {'name': 'prprefix', 'label': 'PR Prefix', 'type': 'char'}, {'name': 'prstartno', 'label': 'PR Start No', 'type': 'long'}]},
    report={'dataobject': 'd_salestype', 'sql': 'SELECT salestype.code AS salestype_code, salestype.name AS salestype_name, salestype.taxperc AS salestype_taxperc, salestype.formno AS salestype_formno, salestype.prefix AS salestype_prefix, salestype.startno AS salestype_startno, salestype.srprefix AS salestype_srprefix, salestype.srstartno AS salestype_srstartno, salestype.pprefix AS salestype_pprefix, salestype.pstartno AS salestype_pstartno, salestype.prprefix AS salestype_prprefix, salestype.prstartno AS salestype_prstartno FROM salestype', 'args': [], 'arg_types': {}, 'tables': ['salestype'], 'columns': [{'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'name', 'label': 'Name', 'type': 'char'}, {'name': 'taxperc', 'label': 'Tax%', 'type': 'decimal'}, {'name': 'formno', 'label': 'Form No', 'type': 'char'}, {'name': 'prefix', 'label': 'SPrefix', 'type': 'char'}, {'name': 'startno', 'label': 'SStartNo', 'type': 'long'}, {'name': 'srprefix', 'label': 'SR Prefix', 'type': 'char'}, {'name': 'srstartno', 'label': 'SR Start No', 'type': 'long'}, {'name': 'pprefix', 'label': 'PPrefix', 'type': 'char'}, {'name': 'pstartno', 'label': 'PStartNo', 'type': 'long'}, {'name': 'prprefix', 'label': 'PR Prefix', 'type': 'char'}, {'name': 'prstartno', 'label': 'PR Start No', 'type': 'long'}]},
)
