...
Generated from the PowerBuilder window ``w_refncancel.srw`` by
...
class CancelForm(GeneratedForm):
    ...
    def build_controls(self):
        ...
        self.add('commandbutton', 'cb_hlp', 1033, 136, 219, 96, text='&Help', taborder=20)
        self.add('statictext', 'st_1', 50, 160, 498, 72, text='Enter Doc. No.  :')
        self.add('oval', 'oval_1', 398, 292, 759, 220)
        self.add('commandbutton', 'cb_ok', 544, 352, 238, 100, text='&OK', taborder=30)
        self.add('commandbutton', 'cb_exit', 795, 352, 238, 100, text='E&xit', taborder=40)
