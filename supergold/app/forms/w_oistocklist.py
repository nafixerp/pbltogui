...
WINDOW = Window(
    ...
    grid={'control': 'dw_1', 'dataobject': 'd_oistocklist', 'table': 'itemsothers', 'keys': ['code'], 'columns': [{'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'name', 'label': 'Item Name', 'type': 'char'}, {'name': 'stock', 'label': 'stock', 'type': 'long'}, {'name': 'grp', 'label': 'grp', 'type': 'char'}, {'name': 'keepstk', 'label': 'keepstk', 'type': 'long'}, {'name': 'cost', 'label': 'cost', 'type': 'decimal'}]},
    report={'dataobject': 'd_oistocklist', 'sql': 'SELECT itemsothers.code AS itemsothers_code, itemsothers.name AS itemsothers_name, itemsothers.stock AS itemsothers_stock, itemsothers.grp AS itemsothers_grp, itemsothers.keepstk AS itemsothers_keepstk, itemsothers.cost AS itemsothers_cost FROM itemsothers ORDER BY itemsothers.name ASC', 'args': ['rlevel'], 'arg_types': {'rlevel': 'number'}, 'tables': ['itemsothers'], 'columns': [{'name': 'code', 'label': 'Code', 'type': 'char'}, {'name': 'name', 'label': 'Item Name', 'type': 'char'}, {'name': 'stock', 'label': 'stock', 'type': 'long'}, {'name': 'grp', 'label': 'grp', 'type': 'char'}, {'name': 'keepstk', 'label': 'keepstk', 'type': 'long'}, {'name': 'cost', 'label': 'cost', 'type': 'decimal'}]},
)
