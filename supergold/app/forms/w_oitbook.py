...
WINDOW = Window(
    ...
    grid={'control': 'dw_saleregister', 'dataobject': 'd_oitsbook', 'table': 'oitemtranm', 'keys': ['docno'], 'computes': [{'name': 'netamt', 'expression': ' billamt  +  addamt  -  lessamt ', 'format': '########0.00', 'label': 'netamt', 'band': 'detail'}, {'name': 'balance', 'expression': 'netamt - ramt', 'format': '########0.00', 'label': 'balance', 'band': 'detail'}, {'name': '', 'expression': 'sum(billamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(addamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(lessamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum( netamt  for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(ramt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum( balance for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}], 'columns': [{'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'docno', 'label': 'docno', 'type': 'char'}, {'name': 'pname', 'label': 'pname', 'type': 'char'}, {'name': 'billamt', 'label': 'billamt', 'type': 'decimal'}, {'name': 'addamt', 'label': 'addamt', 'type': 'decimal'}, {'name': 'lessamt', 'label': 'lessamt', 'type': 'decimal'}, {'name': 'ramt', 'label': 'ramt', 'type': 'decimal'}, {'name': 'sp', 'label': 'sp', 'type': 'char'}, {'name': 'slno', 'label': 'slno', 'type': 'decimal'}]},
    report={'dataobject': 'd_oitsbook', 'sql': 'SELECT oitemtranm.tdate AS oitemtranm_tdate, oitemtranm.docno AS oitemtranm_docno, oitemtranm.pname AS oitemtranm_pname, oitemtranm.billamt AS oitemtranm_billamt, oitemtranm.addamt AS oitemtranm_addamt, oitemtranm.lessamt AS oitemtranm_lessamt, oitemtranm.ramt AS oitemtranm_ramt, oitemtranm.sp AS oitemtranm_sp, oitemtranm.slno AS oitemtranm_slno FROM oitemtranm ORDER BY oitemtranm.tdate ASC, oitemtranm.docno ASC', 'computes': [{'name': 'netamt', 'expression': ' billamt  +  addamt  -  lessamt ', 'format': '########0.00', 'label': 'netamt', 'band': 'detail'}, {'name': 'balance', 'expression': 'netamt - ramt', 'format': '########0.00', 'label': 'balance', 'band': 'detail'}, {'name': '', 'expression': 'sum(billamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(addamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(lessamt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum( netamt  for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum(ramt for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}, {'name': '', 'expression': 'sum( balance for all)', 'format': '########0.00', 'label': '', 'band': 'summary'}], 'args': ['rdate1', 'rdate2', 'rlevel'], 'arg_types': {'rdate1': 'date', 'rdate2': 'date', 'rlevel': 'number'}, 'tables': ['oitemtranm'], 'columns': [{'name': 'tdate', 'label': 'tdate', 'type': 'date'}, {'name': 'docno', 'label': 'docno', 'type': 'char'}, {'name': 'pname', 'label': 'pname', 'type': 'char'}, {'name': 'billamt', 'label': 'billamt', 'type': 'decimal'}, {'name': 'addamt', 'label': 'addamt', 'type': 'decimal'}, {'name': 'lessamt', 'label': 'lessamt', 'type': 'decimal'}, {'name': 'ramt', 'label': 'ramt', 'type': 'decimal'}, {'name': 'sp', 'label': 'sp', 'type': 'char'}, {'name': 'slno', 'label': 'slno', 'type': 'decimal'}]},
)
