...
WINDOW = Window(
    ...
    grid={'control': 'dw_1', 'dataobject': 'd_pcardtable', 'table': 'pcardtable', 'keys': ['pcard', 'isubgrp'], 'computes': [], 'columns': [{'name': 'pcard', 'label': 'Prev.Card', 'type': 'char'}, {'name': 'isubgrp', 'label': 'Item Sub Grp', 'type': 'char'}, {'name': 'pointbasedon', 'label': 'Point Based On', 'type': 'char'}, {'name': 'valuefor1point', 'label': 'Value for 1 Point', 'type': 'decimal'}, {'name': 'valueperpoint', 'label': 'RS Value / Point', 'type': 'decimal'}, {'name': 'minsalesamt', 'label': 'Min Sales Amt', 'type': 'decimal'}, {'name': 'rounddown', 'label': 'Round Down', 'type': 'decimal'}]},
    report={'dataobject': 'd_pcardtable', 'sql': 'SELECT pcardtable.pcard AS pcardtable_pcard, pcardtable.isubgrp AS pcardtable_isubgrp, pcardtable.pointbasedon AS pcardtable_pointbasedon, pcardtable.valuefor1point AS pcardtable_valuefor1point, pcardtable.valueperpoint AS pcardtable_valueperpoint, pcardtable.minsalesamt AS pcardtable_minsalesamt, pcardtable.rounddown AS pcardtable_rounddown FROM pcardtable', 'computes': [], 'args': [], 'arg_types': {}, 'tables': ['pcardtable'], 'columns': [{'name': 'pcard', 'label': 'Prev.Card', 'type': 'char'}, {'name': 'isubgrp', 'label': 'Item Sub Grp', 'type': 'char'}, {'name': 'pointbasedon', 'label': 'Point Based On', 'type': 'char'}, {'name': 'valuefor1point', 'label': 'Value for 1 Point', 'type': 'decimal'}, {'name': 'valueperpoint', 'label': 'RS Value / Point', 'type': 'decimal'}, {'name': 'minsalesamt', 'label': 'Min Sales Amt', 'type': 'decimal'}, {'name': 'rounddown', 'label': 'Round Down', 'type': 'decimal'}]},
)
